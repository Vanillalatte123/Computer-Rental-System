      ...
      <header>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="index.php"><img src="images/CompRent.png" alt="Computer Rental System" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
        ...
        if (isset($_SESSION['userId'])) {
            if($_SESSION['level'] ==1){
                ...
                <li class="nav-item"><a class="nav-link" href="viewAllOrder.php">View All Order</a></li>
                <li class="nav-item"><a class="nav-link" href="delivery.php">Delivery</a></li>
                <li class="nav-item d_none login_btn"><a class="nav-link" href="logout.php">Logout</a></li>';
            }else{

                echo '<li class="nav-item">
                <a class="nav-link" href="index.php">Home</a>
            </li>
                <li class="nav-item"><a class="nav-link" href="productList.php">Our Products</a></li>
